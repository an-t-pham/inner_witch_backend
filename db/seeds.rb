...
magician = Card.create(
    ...
    image: 'https://en.wikipedia.org/wiki/Rider-Waite_tarot_deck#/media/File:RWS_Tarot_01_Magician.jpg' 
    )
...
priestess = Card.create(
    ...
    image: 'https://en.wikipedia.org/wiki/Rider-Waite_tarot_deck#/media/File:RWS_Tarot_02_High_Priestess.jpg'
    )
...
empress = Card.create(
    ...
    image: "https://en.wikipedia.org/wiki/Rider-Waite_tarot_deck#/media/File:RWS_Tarot_03_Empress.jpg"
    )
...
emperor = Card.create(
    ...
    image: "https://en.wikipedia.org/wiki/Rider-Waite_tarot_deck#/media/File:RWS_Tarot_04_Emperor.jpg"
    )
